...
export const AssistantIcon = ({ active }: { active?: boolean }) => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
        <rect x="1.5" y="1.5" width="13" height="13" rx="2" stroke="currentColor" strokeWidth="1.2" fill="none" />
        <rect x="8" y="1.5" width="6.5" height="13" rx="1" fill={active ? 'currentColor' : 'currentColor'} opacity={active ? 0.8 : 0.4} />
    </svg>
);
