...
import { Trash2, SplitSquareHorizontal, Terminal, Play } from 'lucide-react';
import { PowerShellIcon } from '../Icons';
                    ...
                    >
                        <div className={styles.terminalItemMain}>
                            ...
                            <div className={styles.terminalItemName}>
                                {terminal.name || getTerminalTypeLabel(terminal.type).toLowerCase()}
                            </div>
                        </div>
