...
const applyTheme = (themeId: ThemeId) => {
    ...
    root.style.setProperty('--theme-background-primary', colors.background);
    ...
    root.style.setProperty('--theme-accent-foreground', theme.type === 'dark' ? '#ffffff' : '#000000');
    ...
    root.style.setProperty('--theme-overlay', theme.type === 'dark' ? `${colors.background}cc` : `${colors.background}dd`);
    root.style.setProperty('--theme-shadow', theme.type === 'dark' ? 'rgba(0, 0, 0, 0.3)' : 'rgba(0, 0, 0, 0.1)');
    root.style.setProperty('--theme-danger', colors.error);
    root.style.setProperty('--theme-danger-hover', theme.type === 'dark' ? 'rgba(244, 67, 54, 0.1)' : 'rgba(244, 67, 54, 0.05)');
    root.style.setProperty('--theme-accent-rgb', colors.accent.match(/#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})/i)?.slice(1).map(x => parseInt(x, 16)).join(',') || '59, 130, 246');
